...
최초 캠페인에 구현한 몬스터 슬라이스는 **배치 A(M-01·02·03·04·07·13)**였다. 후속 Directive 12는 배치 A 골든 안정과 상태이상 UI 진입 조건을 통과해 배치 B(M-11·12·14 — 중독·치유 차단·턴 종료 응징·나이테 원자)를 추가했다. 배치 C(M-05·06·08 — 보호 재지정·감쇄 임계·오라·사망 정리), D(M-09·10·17·18 — 압수·봉인·위조·속성세), E(M-15·16 — 적측 소환), F(M-19·20 — 보스 페이즈 복합)는 아직 착수하지 않으며, 각 배치의 진입 조건은 P13 설계 정본 §6.4 표를 따른다.
