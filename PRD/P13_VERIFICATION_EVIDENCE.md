...
| 몬스터 배치 A+B | 9종 라이브(2·3막). 배치 B는 중독·치유 차단·미사용 속성 동전 응징·나이테 감쇄/재생/피해 임계를 추가하며, 배치 C~F는 미구현(진입 조건 §6.4) | 신규 적 턴 지표는 시뮬 관측만 — 사람 검증 전 |
...
| 번들 예산 | D12 Batch B 실측 JS 546,480B·CSS 85,615B, 상한 JS 559,104B·CSS 88,064B | 잔여 JS 12,624B·CSS 2,449B로 최소 헤드룸(JS 10KiB·CSS 2KiB) 충족 |
