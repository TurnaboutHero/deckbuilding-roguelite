...
1. **제품·게임 규칙**: [`PRD.md`](./PRD.md)의 최신 변경 이력과 [`../PRD/P7_NEW_DESIGN_DECISIONS.md`](../PRD/P7_NEW_DESIGN_DECISIONS.md)
...
| [`../PRD/P7_NEW_DESIGN_DECISIONS.md`](../PRD/P7_NEW_DESIGN_DECISIONS.md) | 쿨다운·8슬롯·양면 속성 코인·과열 등 P7 결정 로그 | **현재 오버라이드** |
